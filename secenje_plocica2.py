...
dfloor = math.floor(d / p)       # celobrojni broj celih plocica po duzini
dceil = math.ceil(d / p)       # broj plocica, zajedno sa onom koja ce se se seci, po duzini

sfloor = math.floor(s / p)       # celobrojni broj celih plocica po sirini
sceil = math.ceil(s / p)        # broj plocica, zajedno sa onom koja ce se se seci, po sirini
